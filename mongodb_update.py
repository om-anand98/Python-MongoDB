...
# query specifies the parameter to find the document to be changed
query = {'gender': 'Male'}

# new value for the document to be changed based on query
new_value = {'$set': {'first_name': 'Albert'}}

# updates one document where the query matches (if multiple)
